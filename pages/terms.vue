...
<template>
  <v-container class="d-flex align-center justify-center">
    <v-card variant="tonal" max-width="1280">
      <v-card-title class="mt-8 text-h4 font-weight-bold text-center">
        利用規約
      </v-card-title>
      <v-card-text class="text-caption text-md-body-1">
        <v-row class="ma-1 ma-md-8">
          <v-col>
            この利用規約（以下、「当規約」）は、PSO2
            Search（以下、「本サービス」）の利用条件を定めるものです。
            利用者の皆さま（以下、「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
            <div class="mt-4">
              なお、本サービスを利用する場合、本規約に同意したものとみなします。
            </div>
          </v-col>
        </v-row>
        <v-row class="ma-1 ma-md-8">
          <v-col>
            <div class="text-body-1 text-md-h5 font-weight-bold">
              第１条　本サービスの目的
            </div>
            <div class="mt-5">
              本サービスの目的は以下のとおりです。
        ...
        <v-row class="ma-1 ma-md-8">
          <v-col>
            ...
            <div class="mt-5">
              本サービスにおいて、ユーザーは「ユーザ登録」を行いアカウントを作成することができます。<br />
              アカウント作成済みのユーザーは以下の役割を担います。
              <ol>
                <li>
        ...
        <v-row class="ma-1 ma-md-8">
          <v-col>
            ...
            <div class="mt-5">
              <ol>
                <li>
                  ユーザーは、作成したアカウントについて、自己責任において適切に管理するものとします。
                </li>
                <li>
                  アカウント名に本名などの個人情報を用いることはできません。アカウント名に本名などの個人情報を用いたことにより生じた損害について、当方は一切の責任を負いません。
                </li>
                <li>
        ...
        <v-row class="ma-1 ma-md-8">
          <v-col>
            ...
            <div class="mt-5">
              <ol>
                <li>
                  本サービス上のアイテム情報やアイテムの画像は、株式会社SEGAの「
                  <NuxtLink
                    to="https://pso2.jp/players/support/rules/copyright/"
                    target="_blank"
                  >
                    『ファンタシースターオンライン2』著作物利用ガイドライン
                  </NuxtLink>
                  」に則り、株式会社SEGAに属します。<br />
                </li>
                <li>
                  上記のガイドラインを遵守するため、アイテム情報として登録する各種画像には、自動的に「&copy;SEGA」が挿入されます。
                </li>
              </ol>
            </div>
          </v-col>
        ...
        <v-row class="ma-1 ma-md-8">
          <v-col>
            ...
            <div class="mt-5">
              本サービスは非営利目的で運営されており、ユーザーに対して利用料金を請求することはありません。
            </div>
          </v-col>
        </v-row>
          ...
          <v-col>
            ...
            <div class="mt-5">
              <ol>
                ...
                <li>
                  本サービスの提供の停止または中断により、ユーザーまたは第三者が被ったいかなる不利益または損害についても、当方は一切の責任を負わないものとします。
                </li>
              </ol>
            </div>
          </v-col>
        ...
        <v-row class="ma-1 ma-md-8">
          <v-col>
            ...
            <div class="mt-5">
              <ol>
                <li>
                  ユーザーが以下のいずれかに該当する場合には、当方は事前の通知無くユーザーに対して、本サービスの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします。
                </li>
                <ol>
        ...
        <v-row class="ma-1 ma-md-8">
          <v-col>
            <div class="text-body-1 text-md-h5 font-weight-bold mb-8">
              第１５条　通知または連絡
            </div>
            <div class="mt-5">
